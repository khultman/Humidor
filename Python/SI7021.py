...
class SI7021:
	...
	def get_firmware(self):
		self.bus.write_i2c_block_data(self.si7021, 0, READ_FIRMWARE)
		sleep(self.sleep)
		firmware = self.bus.read_i2c_block_data(self.si7021, 0)
		return firmware

	def get_temperature_c(self):
		self.bus.write_byte(self.si7021, READ_TEMP_NH)
		sleep(self.sleep)
		temp = self.bus.read_word_data(self.si7021, READ_TEMP_PREV)
